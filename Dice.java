...
public class Dice {
    ...
    public Dice(int numDice) {
        ...
        if (numDice < 1) {
            throw new IllegalArgumentException("You must create at least one die");
        }
    ...
    /**
     * A private function that rolls a single die. Used for safety to avoid
     * common error in forgetting to maps random ints (from 0 to max) to
     * required ints (from 1 to max+1)
     *
